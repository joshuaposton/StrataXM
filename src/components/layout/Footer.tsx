        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/services/strategy" className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                  Strategy
                </Link>
              </li>
              <li>
                <Link href="/services/implementation" className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                  Implementation
                </Link>
              </li>
            </ul>
